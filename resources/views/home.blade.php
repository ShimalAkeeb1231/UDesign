...
<body>
    <header>
        <nav id="header" class="w-full z-30 top-0 py-1/16 pt-1/32 pb-1/32 bg-gray-10 shadow-sm">
    ...
    <section style="position: relative; padding: 0px; height: 550px;">
        ...
        <p style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 50%; padding: 10px; box-sizing: border-box; margin: 0; font-size: 40px; font-family: 'Your Chosen Font', sans-serif; font-style: italic; color: #fff;">
    ...
    <section>
        ...
        <div class="container mx-auto mt-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <a href="{{ route('products.show', $product->id) }}" class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-white border-2 border-gray-200">
                    @if ($product->image)
                    <!-- Product Image with Hover Effect -->
                    <div class="h-64 overflow-hidden">
                        <img class="w-full h-full object-cover object-center hover:scale-110 transition-transform duration-300" src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}">
                    </div>
                    @endif
                    <!-- Product Details -->
                    <div class="px-1 py-4">
                    ...
                    <div class="px-6 pt-4 pb-2">
                        <span class="bg-gray-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                            View Details
                        </span>
                    </div>
                </a>
